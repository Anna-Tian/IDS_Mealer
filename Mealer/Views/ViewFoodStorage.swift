...
struct ViewFoodStorage: View {
    ...
    @State private var existingIngredients: [Ingredient] = [
        ...
        Ingredient(name: "Bananas", expire: 5, weight: "3 pcs", image: "Ingredients/Bananas", isSelected: false, isNew: false, category: "Fruit", nutrition: Nutrition(name: "Bananas", protein: 1, carbon: 23, fat: 0), createdDate: DateComponents(calendar: Calendar.current, year: 2023, month: 4, day: 3).date!),
